        ...
        {breedCount === BreedCount.MUTT && (
          <p>
            <label style={{ fontSize: 16 }}>
              ...
              >
                <option value={BreedSize.XS}>XSmall {`<`}12 lbs</option>
                <option value={BreedSize.SM}>Small 12-30 lbs</option>
                <option value={BreedSize.M}>Medium 31-60 lbs</option>
                <option value={BreedSize.L}>Large 60-99 lbs</option>
                <option value={BreedSize.XL}>XLarge {`>`}100 lbs</option>
              </select>
            </label>
          </p>
        )}
